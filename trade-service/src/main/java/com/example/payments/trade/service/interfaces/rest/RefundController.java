...
import com.example.payments.trade.service.application.RefundService;
...
public class RefundController {
  ...
  public record RefundResponse(
    ...
    static RefundResponse from(
        com.example.payments.trade.service.infrastructure.persistence.PaymentRefundEntity value) {
