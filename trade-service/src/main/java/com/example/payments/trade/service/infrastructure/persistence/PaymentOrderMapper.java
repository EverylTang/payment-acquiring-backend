...
public interface PaymentOrderMapper extends BaseMapper<PaymentOrderEntity> {
  PaymentOrderEntity findByMerchantOrder(@Param("merchantId") String merchantId, @Param("merchantOrderNo") String merchantOrderNo);

  PaymentOrderEntity findByIdempotency(@Param("merchantId") String merchantId, @Param("key") String key);

  int updateStatus(@Param("orderId") String orderId, @Param("expected") String expected, @Param("next") String next, @Param("paidAt") LocalDateTime paidAt);
