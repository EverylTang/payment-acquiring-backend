...
public interface AdminUserMapper {
  ...
  int insertUser(@Param("username") String username, @Param("passwordHash") String passwordHash, @Param("displayName") String displayName, @Param("now") Instant now);
  int updateUser(@Param("id") long id, @Param("displayName") String displayName, @Param("now") Instant now);
  int updateStatus(@Param("id") long id, @Param("status") String status, @Param("now") Instant now);
  int updatePassword(@Param("id") long id, @Param("passwordHash") String hash, @Param("now") Instant now);
